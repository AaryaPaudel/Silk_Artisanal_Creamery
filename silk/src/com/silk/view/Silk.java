...
public class Silk extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblErrorMsgSpecialNotes.setForeground(new java.awt.Color(204, 0, 0));
        ...
        btnShowAll.setBackground(new java.awt.Color(216, 210, 195));
    ...
    try {
        ...
        isValid &= validateField(
            ...
            errorColor, yellowColor, ValidationUtil.isValidID(id)
        );
    } catch (NumberFormatException e) {
        validateField(tfID, "ID", lblErrorMsgId, "Must be a valid number.",
    ...
    if (!isSearchPerformed){
        ...
        loadListToTable(IceCreamList);
        tfSearch.setText(""); // Replace 'txtSearchField' with your actual search field variable
    
        isSearchPerformed = true;
    // Display a confirmation message
    showDialogBox("All flavors displayed successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
    }
